...
class _StudentSignupScreenState extends State<StudentSignupScreen>
  ...
  void dispose() {
    _fadeCtrl.dispose();
    for (final n in [_nameFocus,_rollFocus,_emailFocus,_mobileFocus,_passwordFocus]) n.dispose();
    for (final c in [_nameCtrl,_rollCtrl,_emailCtrl,_mobileCtrl,_passwordCtrl]) c.dispose();
    super.dispose();
  }
      ...
      body: FadeTransition(
        ...
        child: SlideTransition(
          ...
          child: Form(
            key: _formKey,
            child: ListView(
              // 1. IMPROVEMENT: Dismiss keyboard on scroll
              physics: const BouncingScrollPhysics(),
              keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
              // 2. IMPROVEMENT: Dynamically add padding when keyboard appears
              ...
              children: [
                ...
                // ── Form card (Centered and Constrained for responsiveness) ──
                Center(
